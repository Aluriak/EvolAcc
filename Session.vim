...
set shortmess=aoO
badd +0 evolacc/__main__.py
badd +0 evolacc/simulation/simulation.py
badd +0 evolacc/action/action.py
badd +0 evolacc/unit/unit.py
badd +0 evolacc/unit/component/component.py
badd +0 evolacc/observer/observable.py
badd +0 evolacc/observer/observer.py
badd +0 evolacc/placing/placing.py
argglobal
silent! argdel *
...
tabedit ~/Programmation/Projets/EvolAcc/EvolAcc/evolacc/action/action.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
